...
class Level:  # Тот самый класс, ради которого писался весь код
    ...
    tiles_dict = {
        '.': None,
        '/': ['Textures/wall_texture_side.png', 0],
        '\\': ['Textures/wall_texture_side.png', -180],
        '=': ['Textures/wall_texture_main.png', 180],
        '-': ['Textures/wall_texture_main_with_border.png', 0],
        '(': ['Textures/wall_texture_side_2.png', 180],
        ')': ['Textures/wall_texture_side_2.png', 0],
